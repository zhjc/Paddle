...
USE_ASCEND_CONVERTER(logical_not)
...
USE_ASCEND_CONVERTER(layer_norm)
USE_ASCEND_CONVERTER(c_allreduce_sum)
USE_ASCEND_CONVERTER(c_concat)
...
USE_ASCEND_CONVERTER(lookup_table)

USE_ASCEND_CONVERTER(cast)
USE_ASCEND_CONVERTER(fill_any_like)
USE_ASCEND_CONVERTER(fill_constant)
USE_ASCEND_CONVERTER(split)
USE_ASCEND_CONVERTER(unsqueeze2)
USE_ASCEND_CONVERTER(gelu)
USE_ASCEND_CONVERTER(logsigmoid)
#endif
